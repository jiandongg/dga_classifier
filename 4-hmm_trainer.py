...
words = [w.strip().lower() for w in open("4-alexa_100k.txt").readlines()]
print('words = [w.strip().lower() for w in open(\"4-alexa_100k.txt\").readlines()]')
...
fw = open('4-trans_matrix.csv', 'w')
print('output: 4-trans_matrix.csv 双字符转移矩阵 (key1,key2,value)')
